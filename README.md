...
**[Открыть сайт](https://ваш-логин.github.io/Web-lab-1/)**
...
> Чтобы добавить скриншоты: создайте папку `screenshots/` в корне проекта, поместите туда картинки `desktop.png` и `mobile.png`.
